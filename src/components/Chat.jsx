...
const Chat = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-4 relative">
      ...
      {/* Input */}
      <div className="relative shadow-xl w-full max-w-lg">
        <div className="relative z-20 w-full max-w-lg mx-auto bg-green-700 rounded-3xl bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 md:p-4">
          <p className="text-gray-300 absolute -top-0 right-4 text-xs sm:text-sm italic">
            Hãy hỏi để gửi
          </p>
          <div className="flex flex-col items-center gap-3">
            {/* {showPopup1 && (
              <div>
                <p className="text-red-500">hãy hỏi để gửi</p>
              </div>
            )} */}
            <input
              type="text"
